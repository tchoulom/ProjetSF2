...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // blog_core_home_index
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'blog_core_home_index');
            }

            return array (  '_controller' => 'Blog\\CoreBundle\\Controller\\HomeController::indexAction',  '_route' => 'blog_core_home_index',);
        }

        if (0 === strpos($pathinfo, '/fr')) {
            if (0 === strpos($pathinfo, '/fr/c')) {
                if (0 === strpos($pathinfo, '/fr/creer-commentaire')) {
                    // blog_comment_create
                    if (preg_match('#^/fr/creer\\-commentaire/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
                        if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                            goto not_blog_comment_create;
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'blog_comment_create')), array (  '_controller' => 'Blog\\BlogBundle\\Controller\\Comment\\CRUDController::createAction',));
                    }
                    not_blog_comment_create:

                    // blog_comment_create_reply
                    if (0 === strpos($pathinfo, '/fr/creer-commentaire-reply') && preg_match('#^/fr/creer\\-commentaire\\-reply/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
                        if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                            goto not_blog_comment_create_reply;
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'blog_comment_create_reply')), array (  '_controller' => 'Blog\\BlogBundle\\Controller\\Comment\\CRUDController::createReplyAction',));
                    }
                    not_blog_comment_create_reply:

                }

                // blog_comment_redirection
                if ($pathinfo === '/fr/commentaire-redirection') {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_blog_comment_redirection;
                    }

                    return array (  '_controller' => 'Blog\\BlogBundle\\Controller\\Comment\\CRUDController::redirectionAction',  '_route' => 'blog_comment_redirection',);
                }
                not_blog_comment_redirection:

            }

            // blog_blog_me_contacter
            if ($pathinfo === '/fr/me-contacter') {
                return array (  '_controller' => 'Blog\\BlogBundle\\Controller\\Contact\\ContactController::emailMeAction',  '_route' => 'blog_blog_me_contacter',);
            }

            // blog_cours_creer
            if ($pathinfo === '/fr/creer') {
                return array (  '_controller' => 'Blog\\BlogBundle\\Controller\\Course\\CRUDController::createAction',  '_route' => 'blog_cours_creer',);
            }

            // blog_cours_voir
            if (0 === strpos($pathinfo, '/fr/voir') && preg_match('#^/fr/voir/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_blog_cours_voir;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'blog_cours_voir')), array (  '_controller' => 'Blog\\BlogBundle\\Controller\\Course\\CRUDController::readAction',));
            }
            not_blog_cours_voir:

            // blog_blog_index
            if ($pathinfo === '/fr/blog') {
                return array (  '_controller' => 'Blog\\BlogBundle\\Controller\\HomeController::indexAction',  '_route' => 'blog_blog_index',);
            }

            // blog_user_register
            if ($pathinfo === '/fr/inscription') {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_blog_user_register;
                }

                return array (  '_controller' => 'Blog\\BlogBundle\\Controller\\Users\\CRUDController::registerAction',  '_route' => 'blog_user_register',);
            }
            not_blog_user_register:

            // blog_user_change_password
            if ($pathinfo === '/fr/modifier-mot-de-passe') {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_blog_user_change_password;
                }

                return array (  '_controller' => 'Blog\\BlogBundle\\Controller\\Users\\ChangePasswordController::changePasswordAction',  '_route' => 'blog_user_change_password',);
            }
            not_blog_user_change_password:

            // blog_user_register_validation
            if (0 === strpos($pathinfo, '/fr/inscription/validation') && preg_match('#^/fr/inscription/validation/(?P<confirmationToken>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_blog_user_register_validation;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'blog_user_register_validation')), array (  '_controller' => 'Blog\\BlogBundle\\Controller\\Users\\RegistrationController::changePasswordAction',));
            }
            not_blog_user_register_validation:

            // user_login
            if ($pathinfo === '/fr/login') {
                return array (  '_controller' => 'Blog\\BlogBundle\\Controller\\Users\\SecurityController::loginAction',  '_route' => 'user_login',);
            }
